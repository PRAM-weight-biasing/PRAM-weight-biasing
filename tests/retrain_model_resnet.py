...
""" Training """
# lr =5e-5
lr_list = [5e-4, 1e-4, 5e-5, 1e-5, 1e-6]    # [5e-4, 1e-4, 5e-5, 1e-5, 1e-6]   
num_epochs = 50
...
""" Training """
# lr =5e-5
lr_list2 = [5e-4, 1e-4, 5e-5, 1e-5, 1e-6]       # [5e-4, 1e-4, 5e-5, 1e-5, 1e-6]   
num_epochs = 50
...
# ===========================================
folder_path3 = dir_name + folder_name2
pruned_model3 = torch.load(f'{folder_path2}/{model_name}', map_location='cpu')
